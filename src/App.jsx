...
function App() {
  ...
  useEffect(() => {
    if (isMobile) setUseGeneric(true);
  }, []);
  ...
  return (
    <div>
      {!isMobile && (
        ...
        <div className="switch-container">
          <input
            ...
            type="checkbox"
            checked={useGeneric}
            onChange={() => setUseGeneric(prev => !prev)}
          />
          <div className="switch-button">
            <div className="switch-button-inside">
              <svg className="switch-icon off" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="..." />
              </svg>
              <svg className="switch-icon on" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
      ...
      {useGeneric ? <GenericSite /> : <Portfolio />}
    </div>
  );
}
